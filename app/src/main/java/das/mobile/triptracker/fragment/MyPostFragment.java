...
public class MyPostFragment extends Fragment {
    ...
    public MyPostFragment(FirebaseUser currentUser) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db.child("posts").orderByChild("userId").equalTo(currentUser.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
